  ...
  <b-navbar toggleable :class="classes">
    <div :class="containerClasses">
      ...
      <slot name="toggle-button">
        <button class="navbar-toggler collapsed" v-if="hasMenu" type="button" @click="toggleMenu" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <b-collapse is-nav id="nav-text-collapse" class="navbar-custom-collapse collapse" :class="menuClasses" :visible="show" v-click-outside="closeMenu">
